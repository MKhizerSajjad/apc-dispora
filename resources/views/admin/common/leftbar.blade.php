                ...
                @else
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" style="color: #fff;" href="{{route('users.index')}}">
                            <i class="ri-user-2-line"></i> <span data-key="t-dashboards">Members</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" style="color: #fff;" href="{{route('admins.index')}}">
                            <i class="ri-user-2-line"></i> <span data-key="t-dashboards">Admins</span>
                        </a>
                    </li>
                    {{-- <li class="nav-item">
